	...
	testcases := []struct {
	...
	}{
		{
			...
			validateFunc: func(t *testing.T, runtimeClient client.Client, safeMcaName, mcaName, mcaNamespace string, installPlan operatorsv1alpha1.InstallPlan) {
				...
				assert.Equal(t, mca.ObjectMeta.Annotations[ResourceNameAnnotation], mcaName)
	...
	testcases := []struct {
	...
	}{
		{
			...
			validateFunc: func(t *testing.T, runtimeClient client.Client, safeMcvName, mcvName, mcvNamespace,
				...
				assert.Equal(t, mcv.ObjectMeta.Annotations[ResourceNameAnnotation], mcvName)
	...
	testcases := []struct {
		...
		},
		{
			...
			validateFunc: func(t *testing.T, runtimeClient client.Client, cgu *ranv1alpha1.ClusterGroupUpgrade,
				...
				assert.Equal(t, mcaForInstallPlan.ObjectMeta.Annotations[ResourceNameAnnotation], mcaName)
			},
		},
	}
