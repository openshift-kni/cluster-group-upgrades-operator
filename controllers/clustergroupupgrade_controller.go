...
func (r *ClusterGroupUpgradeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (nextReconcile ctrl.Result, err error) {
	...
	if suceededCondition != nil {
		...
		if progressingCondition == nil || progressingCondition.Status == metav1.ConditionFalse {
...
func (r *ClusterGroupUpgradeReconciler) getSuccessfulClustersList(ctx context.Context, clusterGroupUpgrade *ranv1alpha1.ClusterGroupUpgrade, feature string) ([]string, error) {
	...
	// comment: this condition is valid for backup
	// during building remediation plan after precaching succeeded
