...
type ClusterGroupUpgradeSpecApplyConfiguration struct {
	...
	ManifestWorkTemplates []NamespacedCRApplyConfiguration           `json:"manifestWorkTemplates,omitempty"`
...
func (b *ClusterGroupUpgradeSpecApplyConfiguration) WithManifestWorkTemplates(values ...*NamespacedCRApplyConfiguration) *ClusterGroupUpgradeSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
			panic("nil value passed to WithManifestWorkTemplates")
		}
