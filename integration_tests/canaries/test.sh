...
diff group1-batch-2-placement-rule.spec <(oc get placementrules.apps.open-cluster-management.io group1-batch-2 -ojson | jq -Sc '.spec')
...
diff group1-batch-2-placement-binding.placementRef <(oc get placementbindings.policy.open-cluster-management.io group1-batch-2 -ojson | jq -Sc '.placementRef')
diff group1-batch-2-placement-binding.subjects <(oc get placementbindings.policy.open-cluster-management.io group1-batch-2 -ojson | jq -Sc '.subjects')
