...
--data '{"status":{"conditions":[{"lastTransitionTime":"2022-01-28T17:57:00Z","reason":"GetResourceProcessing","message":"found","status":"True","type":"Processing"}],"result":{"status":{"active": 1}}}}'
